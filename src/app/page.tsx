...
export default function Home() {
  return (
    <main className="min-h-screen w-full p-4 sm:p-6 lg:p-8 flex flex-col items-center justify-start md:justify-center">
      <header className="text-center my-8">
        <h1 className="text-4xl md:text-5xl font-bold font-headline text-foreground flex items-center justify-center gap-3">
          <ShoppingBasket className="h-8 w-8 md:h-10 md:w-10" /> Rupee Relief
        </h1>
